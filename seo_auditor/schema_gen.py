...
def generate_improved_schema(url: str, api_key: str):
    ...
    # Select model - Updated to gemini-2.5-flash as requested
    ...
    try:
        ...
        # This is more efficient for single-turn requests than uploading to File API
        img = Image.open(screenshot_path)

        # Generate content
        # As per latest docs: contents=[prompt, image]
